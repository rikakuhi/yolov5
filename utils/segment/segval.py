...
def validate(testloader, model, numcls, criterion):
    ...
    s = ('%11s' * 5) % ('Images', 'Ave Loss', 'PA', 'IOU', 'mIOU')
    ...
    LOGGER.info('%11g' * 5 % (len(testloader), ave_loss.average(), PA, IoU_array[0], mean_IoU))

    return ave_loss.average(), PA, IoU_array[0], mean_IoU
