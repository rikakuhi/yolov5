from yacs.config import CfgNode as CN  # 用CN作为一个容器存放需要的参数。
...
_C.INPUT.SIZE_TRAIN = [128, 128]  # [384,128]
...
_C.INPUT.PIXEL_MEAN = [0.186, 0.168, 0.156]  # [0.485, 0.456, 0.406]
# Values to be used for image normalization
_C.INPUT.PIXEL_STD = [0.215, 0.192, 0.187]  # [0.229, 0.224, 0.225]
...
_C.DATALOADER.SAMPLER = 'softmax_triplet'  # 可选用哪一种loss进行计算。
...
_C.TEST.WEIGHT = "./mot/weights/resnet18_model_90.pth"
